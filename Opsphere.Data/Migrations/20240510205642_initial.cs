        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_ProjectDevelopers_ProjectId_AssignedDeveloperId",
                        columns: x => new { x.ProjectId, x.AssignedDeveloperId },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CardCommentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reply_CardComments_CardCommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_ProjectId_AssignedDeveloperId",
                table: "Cards",
                columns: new[] { "ProjectId", "AssignedDeveloperId" });
